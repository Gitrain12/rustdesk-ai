// AI快捷按钮Flutter代码示例
// 文件位置: flutter/lib/mobile/widgets/ai_quick_buttons.dart
...
/// 使用示例
class AIQuickButtonsExample extends StatefulWidget {
  const AIQuickButtonsExample({super.key});

  @override
  State<AIQuickButtonsExample> createState() => _AIQuickButtonsExampleState();
}

class _AIQuickButtonsExampleState extends State<AIQuickButtonsExample> {
  void _handleAIAction(String action, Map<String, dynamic> params) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('触发AI功能: $action'),
        content: Text('参数: $params'),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('AI快捷按钮示例'),
      ),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            const Text('下方是AI快捷按钮栏:'),
            const SizedBox(height: 20),
            AIQuickButtonBar(actions: aiActions),
          ],
        ),
      ),
    );
